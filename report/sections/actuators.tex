...
%\begin{figure}[H]
%  \centering
%    \includegraphics[width=1\textwidth]{images/radsPlots.jpg}
...
%ADD NEW PLOTS FOR ALL 4 MOTORS
\begin{figure}[H]
  \centering
